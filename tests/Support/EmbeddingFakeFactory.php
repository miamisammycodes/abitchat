...
class EmbeddingFakeFactory
{
     ...
     */
    public static function single(int $dimensions = 768, float $value = 0.01): EmbeddingsResponseFake
    {
     ...
     */
    public static function many(int $count, int $dimensions = 768, float $value = 0.01): array
    {
        return array_map(
